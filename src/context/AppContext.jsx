...
export const AppProvider = ({ children }) => {
  ...
  const [settings, setSettings] = useState(() => {
    ...
    const defaults = {
      webhook_url: 'https://saikanishka.app.n8n.cloud/webhook-test/a938f841-0d71-4c98-aa06-31d533a11c73',
    ...
    if (saved) {
      ...
      if (parsed.webhook_url === 'https://kanishkaparuchuri.app.n8n.cloud/webhook/a938f841-0d71-4c98-aa06-31d533a11c73' || 
          parsed.webhook_url === 'https://saikanishka.app.n8n.cloud/webhook/a938f841-0d71-4c98-aa06-31d533a11c73') {
        parsed.webhook_url = 'https://saikanishka.app.n8n.cloud/webhook-test/a938f841-0d71-4c98-aa06-31d533a11c73';
      }
  ...
  const publishPostEverywhere = async (postData, triggerWebhook = true) => {
    ...
    if (triggerWebhook && settings.webhook_url) {
      try {
        ...
        // Find the video file
        const selectedVideo = postData.mediaFiles?.find(f => f.rawFile && f.type?.startsWith('video/'))?.rawFile 
          || postData.mediaFiles?.find(f => f.rawFile)?.rawFile 
          || null;

        const prompt = postData.caption || '';
        const selectedPlatforms = postData.selectedPlatforms || [];
